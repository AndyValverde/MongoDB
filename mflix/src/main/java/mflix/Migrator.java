...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            return new UpdateOneModel<Document>(eq("_id",doc.getObjectId("_id")),set("imdb.rating", imdbRating));
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://andy:Avet1409@mflix.xoiwj.mongodb.net";
